...
public class User{
    ...
    public User(long id, String login, String password, ArrayList<ChatRoom> chatRooms, ArrayList<ChatRoom> socialChatRooms){
        this.id = id;
        this.login = login;
        this.password = password;
        this.chatRooms = new LinkedList(chatRooms);
        this.chatRooms = new LinkedList(socialChatRooms);
    }
